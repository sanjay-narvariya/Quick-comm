      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <span style={{ marginLeft: 330, display: 'flex' }}>
            ...
            <span style={{ marginLeft: 10, marginTop: 2 }}> <ShareIcon style={{ width: 25, height: 25 }} /></span>
          </span>
        </div>
...
const handleSelectedProduct=(productdetailid)=>{         
...
const packSize = (index) => {
   ...
   return productList.map((item)=>{
    ...
    return (
      <div onClick={()=>handleSelectedProduct(item.productdetailid)} style={{ display: 'flex', flexDirection: 'column' }}>

        <div style={{ marginTop: 15, width: '100%', height: 50, borderRadius: 20, border: item.productdetailid==productDetailId?`1px solid #0078ad`:`1px solid #000`, padding: 6, display: 'flex', alignItems: 'center', }}>
          <span>
