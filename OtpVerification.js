        ...
        <Paper elevation={3} style={{ flexDirection: 'column', display: 'flex', alignItems: 'center', height: 600, width: 450, marginTop: 40, borderRadius: 24 }}>
          <Grid container>
            ...
            <Grid item xs={12} style={{ marginLeft: 25, }}>
               ...
               Enter the OTP sent to you on<br/><b>+91-8504069643</b>
          ...
          <button onClick={handleSubmit} onMouseLeave={() => setOverState('#b5b5b5')} onMouseOver={() => setOverState('#1f3d4c')} style={{ cursor: 'pointer', marginTop: 20, display: 'flex', justifyContent: 'center', alignItems: 'center', width: '95%', height: 50, border: `0.7px solid ${overState}`, background: '#0f3cc9', color: '#fff', fontSize: 18, fontWeight: 'bold', borderRadius: 30 }}>
               Verify
          </button>
        </Grid>
