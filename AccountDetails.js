        ...
        <Box component="form" onSubmit={handleSubmit} noValidate>
          ...
          <Grid item xs={12} style={{marginLeft:25,cursor:'pointer'}}>
            <LocalizationProvider  dateAdapter={AdapterDayjs} >
              <DatePicker label="Date of birth" value={value1}   
          ...
          <Grid item xs={12} style={{ marginLeft: 25, marginTop: 50, marginBottom: 10, width: '100%' }}>
            <button color="primary" type="submit" style={{ cursor: 'pointer', marginTop: 20, display: 'flex', justifyContent: 'center', alignItems: 'center', width: '95%', height: 50, border: `0.7px solid #b5b5b5`, background: '#0f3cc9', color: '#fff', fontSize: 18, fontWeight: 600, borderRadius: 30 }}>
              Continue
            </button>
          </Grid>
        </Box>
