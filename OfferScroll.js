...
export default function OfferScroll({state,data}) {
  ...
  return (<div style={{position:'relative'}}> 
    {matches?<div onClick={handleNext} style={{top:'43%',left:'0.5%',position:'absolute',zIndex:2,background:'#b2bec3',opacity:0.7,width:30,height:30,borderRadius:15,display:'flex',alignItems:'center',justifyContent:'center'}}>
